...
import { Tag, BookOpen, ArrowLeft } from "lucide-react";

export default function CategoryDetailPage() {
  const params = useParams<{ name: string }>();
  const categoryName = decodeURIComponent(params.name);

  const books = useQuery(api.books.byCategoryCatalog, { category: categoryName });
    ...
    <main className="mx-auto max-w-6xl px-5 py-10">
      ...
      <div className="mb-8 flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
        ...
        <div className="flex flex-wrap items-center gap-2.5 text-[0.8125rem]">
          ...
          <HeaderActionLink href="/categories">
      ...
      {books === undefined ? (
        ...
        <EmptyState
          ...
          message={`No books in "${categoryName}" yet. Share one to get started!`}
        >
